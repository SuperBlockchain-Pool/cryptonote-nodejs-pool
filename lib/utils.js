...
if (config.daemonType === "default" && config.cnAlgorithm === "ethash" && config.cnVariant === 2 &&  config.coin === "Infinium") {
	cnUtil= require('infinium-util');

} else if ( config.daemonType === "default" && config.cnAlgorithm === "ethash" && config.cnVariant === 2 && config.coin === "Zano") {
	cnUtil= require('zano-util');

} else if ( config.daemonType === "default" && config.cnAlgorithm === "ethash" && config.cnVariant === 2 && config.coin === "Evox") {
	cnUtil= require('evox-util');

} else if ( config.daemonType === "default" && config.cnAlgorithm === "ethash" && config.cnVariant === 2 && config.coin === "Nirmata") {
	cnUtil= require('nirmata-util');

} else if ( config.daemonType === "default" && config.coin === "Dogemone") {
	cnUtil= require('cryptonote-util');
